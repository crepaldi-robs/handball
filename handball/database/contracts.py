...
@runtime_checkable
class IntegrationRepositoryContract(Protocol):
    """Persistência isolada das integrações externas por time."""
    ...
    def save_calendar(self, team_id: int, payload: Mapping[str, Any], *, actor_user_id: int) -> dict[str, Any]: ...

    def update_settings(self, team_id: int, payload: Mapping[str, Any], *, actor_user_id: int) -> dict[str, Any]: ...

    def set_connection_status(self, team_id: int, status: str, *, actor_user_id: int, audit_action: str) -> dict[str, Any]: ...
    ...
    def mark_failed(self, operation_id: str, *, code: str, message: str, retryable: bool) -> None: ...
    ...
    def record_sync_result(self, team_id: int, *, status: str, code: str | None = None, message: str | None = None) -> None: ...
...
class UnitOfWorkContract(Protocol):
    ...
    @property
    def integrations(self) -> IntegrationRepositoryContract: ...
